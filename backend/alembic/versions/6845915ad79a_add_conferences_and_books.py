"""Add conferences and books

Revision ID: 6845915ad79a
Revises: 
Create Date: 2026-07-27 15:23:17.804022
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('conferences', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_conferences_id'), ['id'], unique=False)
    ...
    with op.batch_alter_table('book_chapters', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_book_chapters_id'), ['id'], unique=False)
    ...
    sa.Column('book_chapter_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['book_chapter_id'], ['book_chapters.id'], ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('book_chapters', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_book_chapters_id'))
    ...
    op.drop_table('users')
    with op.batch_alter_table('conferences', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_conferences_id'))
